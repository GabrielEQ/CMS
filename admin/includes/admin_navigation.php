 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Nosso CMS</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Gustavo Torrente <b class="caret"></b></a>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="users" class="collapse">
                            <li>
                                <a href="add_users.php">Adicionar novo usuário</a>
                            </li>
                            <li>
                                <a href="users.php">Ver todos os usuários</a>
                            </li>
                        </ul>
                    </li>
